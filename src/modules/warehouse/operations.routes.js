...
const opsAuth = [verifyToken, requireRole(['ADMIN', 'WAREHOUSE_MANAGER', 'INVENTORY_CLERK', 'CLIENT'])];
const execAuth = [verifyToken, requireRole(['ADMIN', 'WAREHOUSE_MANAGER', 'INVENTORY_CLERK'])];
const managerAuth = [verifyToken, requireRole(['ADMIN', 'WAREHOUSE_MANAGER'])];
...
router.post('/locations/update', ...execAuth, opsController.updateLocation);
