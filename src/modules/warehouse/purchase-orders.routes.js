...
const readAuth = requireRole(['ADMIN', 'WAREHOUSE_MANAGER', 'INVENTORY_CLERK']);
const execAuth = requireRole(['ADMIN', 'WAREHOUSE_MANAGER', 'INVENTORY_CLERK']);
const deleteAuth = requireRole(['ADMIN', 'WAREHOUSE_MANAGER']);
