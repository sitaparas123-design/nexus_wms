...
const defaultPermissions = {
  ADMIN: [
    ...
    'facilities.view', 'facilities.create', 'facilities.manage',
    'barcode.view', 'barcode.generate', 'barcode.print',
    'picking.view', 'picking.execute',
    'shipping.view', 'shipping.create', 'shipping.track', 'shipping.manage', 'shipping.execute', 'shipping.delete',
    'client_portal.view', 'client_portal.orders', 'client_portal.order_create', 'client_portal.tracking', 'client_portal.reports', 'client_portal.invoices',
  ...
  INVENTORY_CLERK: [
    ...
    'batch.view',
    'expiry.view',
    'po.view', 'receiving.execute',
    'to.view', 'to.create', 'to.execute',
    'so.view',
    'picking.view', 'picking.execute',
    'shipping.view', 'shipping.execute', 'shipping.track',
    'warehouse.view',
    'barcode.view', 'barcode.generate', 'barcode.print'
  ],
  CLIENT: [
